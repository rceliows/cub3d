...
{
	int **world_map; // needs parsing input
	char *n_xpm_path;                   // needs parsing input
	char *s_xpm_path;                   // needs parsing input
	char *e_xpm_path;                   // needs parsing input
	char *w_xpm_path;                   // needs parsing input
	char				*door_path;
	char				*sprite_path;
	void				*texture[6];
	int					texture_width[6];
	...
	void				*sprite_image;
	void				*door_image;
	int ceiling_color;       // needs parsing input
	int floor_color;         // needs parsing input
	double start_position_x; // needs parsing input
	double start_position_y; // needs parsing input
	int start_direction;     // needs parsing input
}						t_map;
...
void					draw_sprite_stripe(t_cub3d *cub3d,
							t_sprite_data *sprites, int sprite_idx,
							t_sprite_var *vs);
